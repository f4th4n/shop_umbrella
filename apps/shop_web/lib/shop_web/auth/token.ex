defmodule ShopWeb.Auth.Token do
  ...
  def sign(data) do
    Phoenix.Token.sign(ShopWeb.Endpoint, @signing_salt, data)
  end
  ...
  def verify(token) do
    case Phoenix.Token.verify(ShopWeb.Endpoint, @signing_salt, token, max_age: @token_age_secs) do
      {:ok, data} -> {:ok, data}
